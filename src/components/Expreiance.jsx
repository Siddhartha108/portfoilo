...
function Expreiance() {
     ...
     return (
          <div name="Expreiance" className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-14"
          >
               ...
               <div className="flex justify-evenly items-center p-5 my-8">
                    ...
                    <div className="bg-[#a79fce] hover:bg-[#6E57E0] hover:text-white rounded-lg cursor-pointer">
                         <svg xmlns="http://www.w3.org/2000/svg" fill="none" onClick={perv} viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-10">
                    ...
                    <div>
                         {
                              projects.map(({ id, img, h1, p, url }, index) =>
                                   curr === index && (
                                        <div key={id}>
                                             <div className="flex justify-center">
                                                  <img src={img} className="rounded-xl" alt="" height={300} width={300} />
                                             </div>
                                             <div className="flex justify-center">
                                                  ...
                                                  <div className="w-2/3 my-4">
                                                       ...
                                                       <div className="mt-8">
                                                            <button><a href={url} className="bg-[#6E57E0] rounded-md hover:bg-[#5A43CB] text-white py-4 px-4 flex items-center"> Demo <span className="ml-1"><IoArrowForwardOutline /></span></a></button>
                                                       </div>
                    ...
                    {/* **Next button** */}
                    <div className="bg-[#a79fce] hover:bg-[#6E57E0] hover:text-white rounded-lg cursor-pointer">
                         <svg xmlns="http://www.w3.org/2000/svg" fill="none" onClick={next} viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-10">
